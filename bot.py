#!/usr/bin/env python3
"""
VERTEX PREMIUM SMS BOT – Final Fixed Version
...
_BOT_TOKEN_ENC = "ODYyNzQ5MDI0NTpBQUcxLTV1Q1FKbGhacW8xeF9QLXNiUVBqN0JkRnhlUEpXOA=="
BOT_TOKEN = os.getenv("BOT_TOKEN") or base64.b64decode(_BOT_TOKEN_ENC).decode("utf-8")
ADMIN_ID = int(os.getenv("ADMIN_ID", "8119221293"))
EXTRA_ADMINS = [8921746989]

WSS_URL = "wss://ivasms.qzz.io:2087/livesms?token=%3D&user=81d1d9839bdd2141f706d3cf6ee686ef"
WSS_HEADERS = {
...
def init_db():
    with _db_lock:
        ...
        c.execute("INSERT OR IGNORE INTO bot_settings (key, value) VALUES ('watermark', 'VERTEX')")
...
def send_otp_to_user_and_group(date_str, number, sms, app_name=None):
    ...
    if user_id:
        try:
            ...
            msg = (f"{pe('fire', '🏆')} <b>VERTEX</b> {pe('fire', '🏆')}\n"
...
def show_admin_panel(chat_id, message_id=None):
    if not is_admin(chat_id):
        return
    data = load_data()
    watermark = data.get("watermark", "VERTEX")
